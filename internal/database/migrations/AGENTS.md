...
- Rollback: down migration supports `database.Rollback()` latest
...
- Key files: `internal/database/migrate.go`, `internal/database/db.go`, `internal/database/migrations/*.sql`, `cmd/test-helper/main.go`
