...
- Table Row Design: Use `even:bg-canvas-100/30` for zebra striping and `hover:bg-brand/[0.02]` for row focus. Use `px-6 py-4` for table cells to ensure a spacious, premium feel.
